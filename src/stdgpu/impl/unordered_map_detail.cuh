...
__attribute__((noinline)) STDGPU_HOST_DEVICE typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::allocator_type
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_DEVICE_ONLY typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::iterator
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_DEVICE_ONLY typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::const_iterator
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_HOST_DEVICE typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::index_type
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_DEVICE_ONLY typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::index_type
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
template <class... Args>
__attribute__((noinline)) STDGPU_DEVICE_ONLY pair<typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::iterator, bool>
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_HOST_DEVICE float
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_HOST_DEVICE typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::hasher
...
template <typename Key, typename T, typename Hash, typename KeyEqual, typename Allocator>
__attribute__((noinline)) STDGPU_HOST_DEVICE typename unordered_map<Key, T, Hash, KeyEqual, Allocator>::key_equal
